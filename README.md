...
**Full Stack Web/App Development** — React, React Native, Next.js, Node.js, Nest.js, Express, FastAPI, Tailwind

**AI & Machine Learning** — TensorFlow, Scikit-Learn, NLP, RAG Systems

**Backend & Databases** — MongoDB, MySQL, PostgreSQL, Redis, NeonDB, Inngest, Supabase

**DevOps & Tooling** — Git, Linux, Postman, Docker, AWS (EC2, ECS, etc.), Nginx

**LLM & Agentic AI** — LangChain, LangGraph, AI SDK, OpenAI, Ollama, FAISS, ChromaDB
